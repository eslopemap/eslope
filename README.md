...
| Dataset      | W | C | E | Res | Projection        | Dataset name | Doc / WebGIS |
| --           | - | - | - |--  |  --                | --           | -- |
| FR:IGN       | ✓ | - | - |5/40m| `2154`:Lambert93  | RGE ALTI 5m                                  | [geoservices.ign.fr][1] / [geoportail.gouv.fr][2] |
| IT:Piemont   | ✓ | ✓ | - |  5m | `32632`:WGS84/32N | RIPRESA AEREA ICE 2009-2011 - DTM 5          | [geoportale.piemonte.it][3] |
| IT:Aoste     | ✓ | ✓ | - |  2m | `23032`:ED50/32N  | DTM 2005 / 2008 aggregato                    | [geoportale.regione.vda.it][5] |
| CH:SwissTopo | - | ✓ | - |  2m | `2056`:LV95/LN02  | swissALTI3D                                  | [swisstopo.admin.ch][7] / [map.geo.admin.ch][8] |
| IT:Lombardia | - | ✓ | - |  5m | `32632`:WGS84/32N | DTM 5X5 - Modello digitale del terreno 2015  | [geoportale.regione.lombardia.it][15] |
| IT:Trentino  | - | ✓ | ✓ |  2m | `25832`:ETRS89/32N | LiDAR PAT 2014 integrato con voli 2018      | [territorio.provincia.tn.it][9] / [siat.provincia.tn.it][10] |
| IT:Sud-Tyrol | - | ✓ | ✓ |2.5m | `25832`:ETRS89/32N | Digitales Geländemodell Südtirols (DGM 2,5m)| / [geokatalog.buergernetz.bz.it][11] |
| DE:Bavaria   | - | - | ✓ | 50m ||||
| AT:Tyrol     | - | ✓ | ✓ |  5m |`31254`:MGI/AustriaW| Digitales Geländemodell Tirol, 5m  | [tirol.gv.at][13] / [tiris.maps.arcgis.com][14]
| AT:Salzburg  | - | - | ✓ |  5m ||||
| AT:Vorarlberg| - | - | ✓ |  5m ||||
